            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h3 class="page-title mt-3 ml-3 mb-3">리뷰 게시글 신고</h3>
                                    ...
                                    <c:if test="${!empty list}">
                                        <c:forEach var="review" items="${list}" varStatus="vs">
                                            <tr>
                                                ...
                                                <td><a class = "report" onclick="location.href='${contextPath}/admin/updateRpCnt?rpCnt=${rvreport.reviewReportSuspector}'"><i class="fas fa-exclamation-triangle"></i></a></td>
                                        		<td>상태</td>
                                            </tr>
                                        </c:forEach>
                                    </c:if>

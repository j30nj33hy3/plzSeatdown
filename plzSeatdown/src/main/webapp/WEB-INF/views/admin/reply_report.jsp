                                    ...
                                    <c:if test="${!empty list}">
                                        <c:forEach var="review" items="${list}" varStatus="vs">
                                            <tr>
                                                ...
                                                <td><a class = "report" onclick="location.href='${contextPath}/admin/updateRpCnt?rpCnt=${rpreport.replyReportSuspector}'"><i class="fas fa-exclamation-triangle"></i></a></td>
                                        		<td>상태</td>
                                            </tr>
                                        </c:forEach>
                                    </c:if>

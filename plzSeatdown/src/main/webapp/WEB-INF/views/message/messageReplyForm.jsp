		...
		<div id="chattop">
			...
			<div class="buttonArea">
				<form action="replyForm">
					<button class="btn btn-primary btn-sm d-md-inline-block headBtn otherBtn replyBtn"
						type="submit">전송</button>
					<a class="btn btn-primary btn-sm d-md-inline-block headBtn btn btn-sm deleteBtn"
